...
import (
	...
	imp "go.openfeature.dev/openfeature/v2/providers/inmemory"
...
func TestMultiProvider_ConfigurationChangedEventForwarding(t *testing.T) {
	...
	setup := func(t *testing.T) (*Provider, *mockProviderWithEvents, *mockProviderWithEvents) {
		...
		require.NoError(t, mp.Init(t.Context()))
		require.Eventually(t, func() bool {
...
func newMockProviderWithEvents(ctrl *gomock.Controller, name string) *mockProviderWithEvents {
	...
	mockStateHandler.EXPECT().Init(gomock.Any()).DoAndReturn(func(ctx context.Context) error {
...
func (m *mockProviderWithEvents) Init(ctx context.Context) error {
	return m.MockStateHandler.Init(ctx)
}
