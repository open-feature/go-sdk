...
func (h *hookIsolator) Before(ctx context.Context, hookContext of.HookContext, hookHints of.HookHints) (context.Context, error) {
...
func (h *hookIsolator) beforeHooks(ctx context.Context) (context.Context, of.EvaluationContext, error) {
	...
	for _, hook := range h.hooks {
		tctx, err := hook.Before(ctx, h.capturedContext, h.capturedHints)
		if tctx != nil {
			ctx = tctx
