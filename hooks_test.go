...
func TestRequirement_4_3_7(t *testing.T) {
	...
	t.Run("finally hook MUST run after the error stage", func(t *testing.T) {
		...
		mockHook.EXPECT().Before(gomock.Any(), gomock.Any(), gomock.Any()).Return(t.Context(), errors.New("forced"))
...
func TestRequirement_4_4_6(t *testing.T) {
	...
	t.Run(
		...
		func(t *testing.T) {
			...
			mockHook1.EXPECT().Before(gomock.Any(), gomock.Any(), gomock.Any()).Return(t.Context(), errors.New("forced"))
