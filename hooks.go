...
func (UnimplementedHook) Before(ctx context.Context, _ HookContext, _ HookHints) (context.Context, error) {
	return ctx, nil
}

func (UnimplementedHook) After(context.Context, HookContext, HookEvaluationDetails, HookHints) error {
	return nil
}

func (UnimplementedHook) Error(context.Context, HookContext, error, HookHints) {}

func (UnimplementedHook) Finally(context.Context, HookContext, HookEvaluationDetails, HookHints) {
}
