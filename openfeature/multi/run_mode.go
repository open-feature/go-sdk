...
type runModeFn[T FlagTypes] func(ctx context.Context, providers []namedProvider, flag string, defaultValue T, flatCtx of.FlattenedContext) ResolutionIterator[T]
...
func runModeParallel[T FlagTypes](ctx context.Context, providers []namedProvider, flag string, defaultValue T, flatCtx of.FlattenedContext) ResolutionIterator[T] {
...
func runModeSequential[T FlagTypes](ctx context.Context, providers []namedProvider, flag string, defaultValue T, flatCtx of.FlattenedContext) ResolutionIterator[T] {
	return func(yield func(string, *of.GenericResolutionDetail[T]) bool) {
		for _, provider := range providers {
			select {
			case <-ctx.Done():
