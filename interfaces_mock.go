...
//
//	mockgen -destination=openfeature/interfaces_mock.go -package=openfeature -build_constraint=testtools -mock_names=FeatureProvider=MockProvider go.openfeature.dev/openfeature/v2 clientEvent,evaluationImpl,Hook,FeatureProvider,StateHandler,Tracker
//
