...
func (m *MockFeatureProvider) NumberEvaluation(flag string, defaultValue float64, evalCtx EvaluationContext, options EvaluationOptions) NumberResolutionDetail {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NumberEvaluation", flag, defaultValue, evalCtx, options)
	ret0, _ := ret[0].(NumberResolutionDetail)
	return ret0
}

// NumberEvaluation indicates an expected call of NumberEvaluation.
func (mr *MockFeatureProviderMockRecorder) NumberEvaluation(flag, defaultValue, evalCtx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NumberEvaluation", reflect.TypeOf((*MockFeatureProvider)(nil).NumberEvaluation), flag, defaultValue, evalCtx, options)
}
