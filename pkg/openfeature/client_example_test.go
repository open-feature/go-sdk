...
func ExampleClient_BooleanValue() {
	...
	value, err := client.BooleanValue(
		"test-flag", true, openfeature.EvaluationContext{},
	)
	if err != nil {
...
func ExampleClient_StringValue() {
	...
	value, err := client.StringValue(
		"test-flag", "openfeature", openfeature.EvaluationContext{},
	)
	if err != nil {
...
func ExampleClient_FloatValue() {
	...
	value, err := client.FloatValue(
		"test-flag", 0.55, openfeature.EvaluationContext{},
	)
	if err != nil {
...
func ExampleClient_IntValue() {
	...
	value, err := client.IntValue(
		"test-flag", 3, openfeature.EvaluationContext{},
	)
	if err != nil {
...
func ExampleClient_ObjectValue() {
	...
	value, err := client.ObjectValue(
		"test-flag", map[string]string{"foo": "bar"}, openfeature.EvaluationContext{},
	)
	if err != nil {
